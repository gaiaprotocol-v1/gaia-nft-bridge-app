...
export default class TestSwaper extends DomNode {
    ...
    constructor() {
        ...
        this.append(
            el("section.swap-container",
                ...
                el(".form-container",
                    (this.fromForm = new TestForm(this, savedFromChainId === undefined ? 8217 : savedFromChainId, savedNFTName === undefined ? "GENESIS" : savedNFTName, true)),
                    el("a", {
                        click: () => {
                    ...
                    (this.toForm = new TestForm(this, savedToChainId === undefined ? 1 : savedToChainId, savedNFTName === undefined ? "GENESIS" : savedNFTName))
                ),
                el(".amount-container",
                    el(".title-container",
                        el(".title", "NFTs"),
    ...
    private async loadHistory() {
        ...
        if (
            ...
            const sender = "0x1c99aFAABc3670B3BC515527ae1913d8A71DE4f7";//await this.fromForm.sender.loadAddress();
            const receiver = "0x348c958Aba981DDA3266a7eaD367e72408B12b1e";//await this.toForm.sender.loadAddress();
