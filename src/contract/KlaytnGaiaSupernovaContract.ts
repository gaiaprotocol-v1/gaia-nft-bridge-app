...
class KlaytnGaiaSupernovaContract extends KIP17Contract {

    constructor() {
        super("0x20a33C651373cde978daE404760e853fAE877588", IERC721Artifact.abi);
        this.watch();
    }
...
export default new KlaytnGaiaSupernovaContract();
