...
export interface GaiaNFTBridgeInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "isNFTsReceived",
    values: [
...
export type ReceiveNFTsEvent = TypedEvent<
  [string, BigNumber, string, string, string, BigNumber[], BigNumber],
  ReceiveNFTsEventObject
>;

export type ReceiveNFTsEventFilter = TypedEventFilter<ReceiveNFTsEvent>;
...
export type SendNFTsEvent = TypedEvent<
  [string, BigNumber, string, string, string, BigNumber[], BigNumber],
  SendNFTsEventObject
>;

export type SendNFTsEventFilter = TypedEventFilter<SendNFTsEvent>;

export interface SetSignerEventObject {
  newSigner: string;
}
export type SetSignerEvent = TypedEvent<[string], SetSignerEventObject>;
...
export interface GaiaNFTBridge extends BaseContract {
  ...
  functions: {
    ...
    receiveNFTs(
      ...
      sendingId: PromiseOrValue<BigNumberish>,
  ...
  filters: {
    ...
    "ReceiveNFTs(address,uint256,address,string,address,uint256[],uint256)"(
    ...
    "SendNFTs(address,uint256,address,string,address,uint256[],uint256)"(
      sender?: PromiseOrValue<string> | null,
