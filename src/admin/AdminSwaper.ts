...
import AdminSended from "./AdminSended";

export default class AdminSwaper extends DomNode {
    private fromForm: AdminForm;
    private toForm: AdminForm;
    ...
    constructor() {
        ...
        this.append(
            el("section.swap-container",
                ...
                el(".form-container",
                    (this.fromForm = new AdminForm(this, savedFromChainId === undefined ? 8217 : savedFromChainId, savedNFTName === undefined ? "GENESIS" : savedNFTName, true)),
                    el("a", {
                        click: () => {
                    ...
                    (this.toForm = new AdminForm(this, savedToChainId === undefined ? 1 : savedToChainId, savedNFTName === undefined ? "GENESIS" : savedNFTName))
                ),
                el(".amount-container",
                    el(".title-container",
                        el(".title", "NFTs"),
                ...
                el(".button-container",
                    el(".content",
                        ...
                        this.transferButton = el("button", "Transfer\n전송하기", {
                            click: () => {
                                new Confirm("주의사항", "전송이 시작되면 돌이킬 수 없으며, 반드시 전송하기 전에 양쪽 체인에 가스비가 충분한지 확인하세요. 가스비가 충분하지 않으면 정상적으로 진행되지 않습니다. 가스비를 충전하고 이용해주시기 바랍니다.", "확인했습니다.", () => {
    ...
    private async loadHistory() {
        ...
        if (
            ...
            const sender = "0x2d476b4e5c478bE6b6a97feCa4Aa80455395Ab98";//await this.fromForm.sender.loadAddress();
            const receiver = "0x875BA94eB1a00a04BF4F4Fc37780b95b1633292b";//await this.toForm.sender.loadAddress();
    ...
    public async receive(
        ...
        if (
            ...
            const receiver = _receiver//await this.toForm.sender.loadAddress();
