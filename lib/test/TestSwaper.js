...
const TestSended_1 = __importDefault(require("./TestSended"));
class TestSwaper extends skydapp_browser_1.DomNode {
    constructor() {
        super(".swaper");
        ...
        this.append((0, skydapp_browser_1.el)("section.swap-container", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.el)("h1", "GAIA BRIDGE"), (0, skydapp_browser_1.el)("p", "NFT SWAP")), (0, skydapp_browser_1.el)(".form-container", (this.fromForm = new TestForm_1.default(this, savedFromChainId === undefined ? 8217 : savedFromChainId, savedNFTName === undefined ? "GENESIS" : savedNFTName, true)), (0, skydapp_browser_1.el)("a", {
            click: () => {
        ...
        }, (0, skydapp_browser_1.el)("img.arrow", { src: "/images/shared/icn/arrow-right.svg", height: "50", alt: "arrow-right" })), (this.toForm = new TestForm_1.default(this, savedToChainId === undefined ? 1 : savedToChainId, savedNFTName === undefined ? "GENESIS" : savedNFTName))), (0, skydapp_browser_1.el)(".amount-container", (0, skydapp_browser_1.el)(".title-container", (0, skydapp_browser_1.el)(".title", "NFTs")), (0, skydapp_browser_1.el)(".tab-container", (0, skydapp_browser_1.el)("a.genesis", "Genesis", {
            click: () => {
            ...
            click: () => {
                new Confirm_1.default("주의사항", "반드시 전송하기 전에 양쪽 체인에 가스비가 충분한지 확인하세요. 가스비가 충분하지 않으면 정상적으로 진행되지 않습니다. 가스비를 충전하고 이용해주시기 바랍니다.", "확인했습니다.", () => {
    ...
    async loadHistory() {
        ...
        if (this.fromForm.sender !== undefined &&
            ...
            const sender = "0x1c99aFAABc3670B3BC515527ae1913d8A71DE4f7";
            const receiver = "0x348c958Aba981DDA3266a7eaD367e72408B12b1e";
    ...
    addSended(sender, receiver, sendingId, ids, block) {
        if (this.fromForm.sender !== undefined &&
            this.toForm.sender !== undefined) {
            new TestSended_1.default(this.fromForm.sender, this.toForm.sender, this.fromForm.chainId, this.toForm.chainId, sender, receiver, sendingId.toNumber(), ids, async () => {
                if (this.fromForm.sender !== undefined) {
...
exports.default = TestSwaper;
//# sourceMappingURL=TestSwaper.js.map