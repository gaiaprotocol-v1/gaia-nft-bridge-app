...
class AdminForm extends skydapp_browser_1.DomNode {
    constructor(swaper, chainId, nftName, isFrom = false) {
        ...
        this.append(this.chainIcon = (0, skydapp_browser_1.el)("img", { src: "/images/shared/icn/klaytn.svg", alt: "chain image" }), this.isFrom ? (0, skydapp_browser_1.el)(".caption-container", (0, skydapp_browser_1.el)("span", "from"), (0, skydapp_browser_1.el)("p", "보내는 체인")) :
            (0, skydapp_browser_1.el)(".caption-container", (0, skydapp_browser_1.el)("span", "to"), (0, skydapp_browser_1.el)("p", "받는 체인")), this.chainSelect = (0, skydapp_browser_1.el)("select", (0, skydapp_browser_1.el)("option", "Klaytn", { value: "8217" }), (0, skydapp_browser_1.el)("option", "Ethereum", { value: "1" }), (0, skydapp_browser_1.el)("option", "Polygon", { value: "137" }), {
            change: () => {
    ...
    async changeChain(chainId) {
        ...
        if (chainId === 8217) {
            ...
            this.sender = PolygonGaiaNFTBridgeContract_1.default;
            ...
            if (owner !== undefined) {
                ...
                if (this.isFrom === true) {
                    ...
                    if (this.chainId === 8217) {
                        ...
                        const result = await fetch(`${Config_1.default.apiURI}/gaia-protocol-pfp/polygon/${Contracts_1.default[this.chainId][this.nftName].address}/${owner}`);
...
//# sourceMappingURL=AdminForm.js.map