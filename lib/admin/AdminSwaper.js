...
const PolygonGaiaNFTBridgeContract_1 = __importDefault(require("../contract/PolygonGaiaNFTBridgeContract"));
...
const AdminForm_1 = __importDefault(require("./AdminForm"));
const AdminSended_1 = __importDefault(require("./AdminSended"));
class AdminSwaper extends skydapp_browser_1.DomNode {
    constructor() {
        super(".swaper");
        ...
        this.append((0, skydapp_browser_1.el)("section.swap-container", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.el)("h1", "GAIA BRIDGE"), (0, skydapp_browser_1.el)("p", "NFT SWAP")), (0, skydapp_browser_1.el)(".form-container", (this.fromForm = new AdminForm_1.default(this, savedFromChainId === undefined ? 8217 : savedFromChainId, savedNFTName === undefined ? "GENESIS" : savedNFTName, true)), (0, skydapp_browser_1.el)("a", {
            click: () => {
        ...
        }, (0, skydapp_browser_1.el)("img.arrow", { src: "/images/shared/icn/arrow-right.svg", height: "50", alt: "arrow-right" })), (this.toForm = new AdminForm_1.default(this, savedToChainId === undefined ? 1 : savedToChainId, savedNFTName === undefined ? "GENESIS" : savedNFTName))), (0, skydapp_browser_1.el)(".amount-container", (0, skydapp_browser_1.el)(".title-container", (0, skydapp_browser_1.el)(".title", "NFTs")), (0, skydapp_browser_1.el)(".tab-container", (0, skydapp_browser_1.el)("a.genesis", "Genesis", {
            click: () => {
            ...
            click: async () => {
                ...
                if (fromChainId === 1) {
                    ...
                    this.fromForm.nftContract.setApprovalForAll(PolygonGaiaNFTBridgeContract_1.default.address, true);
                }
            ...
            click: () => {
                new Confirm_1.default("주의사항", "전송이 시작되면 돌이킬 수 없으며, 반드시 전송하기 전에 양쪽 체인에 가스비가 충분한지 확인하세요. 가스비가 충분하지 않으면 정상적으로 진행되지 않습니다. 가스비를 충전하고 이용해주시기 바랍니다.", "확인했습니다.", () => {
    ...
    async getApprove(chainId) {
        ...
        if (chainId === 1) {
            ...
            if (owner !== undefined) {
                if (await contract.isApprovedForAll(owner, PolygonGaiaNFTBridgeContract_1.default.address) !== true) {
                    this.approveButton.domElement.disabled = false;
                    this.transferButton.domElement.disabled = true;
                }
                else {
    ...
    async loadHistory() {
        ...
        if (this.fromForm.sender !== undefined &&
            ...
            const sender = "0x2d476b4e5c478bE6b6a97feCa4Aa80455395Ab98";
            const receiver = "0x875BA94eB1a00a04BF4F4Fc37780b95b1633292b";
    ...
    addSended(sender, receiver, sendingId, ids, block) {
        if (this.fromForm.sender !== undefined &&
            this.toForm.sender !== undefined) {
            new AdminSended_1.default(this.fromForm.sender, this.toForm.sender, this.fromForm.chainId, this.toForm.chainId, sender, receiver, sendingId.toNumber(), ids, async () => {
                if (this.fromForm.sender !== undefined) {
...
exports.default = AdminSwaper;
//# sourceMappingURL=AdminSwaper.js.map