...
class NftItem extends skydapp_browser_1.DomNode {
    constructor(name, id) {
        super(".nft-item");
        this.id = id;
        this.append((0, skydapp_browser_1.el)("img", { src: `https://storage.googleapis.com/gaia-protocol/${name === "genesis" ? "kronos" : name}/${id}.png`, alt: `nft${id}` }), (0, skydapp_browser_1.el)(".checkbox-container", this.checkbox = (0, skydapp_browser_1.el)("input", { type: "checkbox", id: `nft${id}` }, {
            change: () => {
