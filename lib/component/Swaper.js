...
class Swaper extends skydapp_browser_1.DomNode {
    constructor() {
        ...
        this.append((0, skydapp_browser_1.el)("section.swap-container", (0, skydapp_browser_1.el)("header", (0, skydapp_browser_1.el)("h1", "GAIA BRIDGE"), (0, skydapp_browser_1.el)("p", "NFT SWAP")), (0, skydapp_browser_1.el)(".form-container", (this.fromForm = new Form_1.default(this, savedFromChainId === undefined ? 8217 : savedFromChainId, savedNFTName === undefined ? "GENESIS" : savedNFTName, true)), (0, skydapp_browser_1.el)("a", {
            ...
            click: async () => {
                ...
                const fromChainId = this.fromForm.chainId;
                const contract = Contracts_1.default[fromChainId][nftName];
                if (fromChainId === 1) {
                    contract.setApprovalForAll(EthereumGaiaNFTBridgeContract_1.default.address, true);
                }
                else if (fromChainId === 8217) {
                    contract.setApprovalForAll(KlaytnGaiaNFTBridgeContract_1.default.address, true);
                }
            ...
            click: () => {
                const nftName = this.store.get("nft") ?? "GENESIS";
                this.send(nftName, Contracts_1.default[this.fromForm.chainId][nftName].address, this.selectedIds);
            },
        })))), (0, skydapp_browser_1.el)("section.history-container", (0, skydapp_browser_1.el)(".title", "전송 이력"), (0, skydapp_browser_1.el)("p", "트랜잭션이 한번 시작되면 되돌릴 수 없습니다.\nTransfer후 Claim 까지 완료되어야 체인 간 전송이 완료됩니다"), (0, skydapp_browser_1.el)("table", (0, skydapp_browser_1.el)("thead", (0, skydapp_browser_1.el)("tr", (0, skydapp_browser_1.el)("td", "From Chain"), (0, skydapp_browser_1.el)("td", "To Chain"), (0, skydapp_browser_1.el)("td", "Name"), (0, skydapp_browser_1.el)("td", "Fee"), (0, skydapp_browser_1.el)("td", "Time"), (0, skydapp_browser_1.el)("td", "Status"))), this.sendedList = (0, skydapp_browser_1.el)("tbody"))));
    ...
    async loadHistory() {
        ...
        if (this.fromForm.sender !== undefined &&
            ...
            if (sender !== undefined && receiver !== undefined) {
                const nftName = this.store.get("nft") ?? "GENESIS";
                const contract = Contracts_1.default[this.fromForm.chainId][nftName];
                const sended = await this.fromForm.sender.loadSended(sender, this.toForm.chainId, receiver, nftName, contract.address);
    ...
    addSended(sender, receiver, sendingId, ids) {
        if (this.fromForm.sender !== undefined &&
            this.toForm.sender !== undefined) {
            new Sended_1.default(this.fromForm.sender, this.toForm.sender, this.fromForm.chainId, this.toForm.chainId, sender, receiver, sendingId.toNumber(), ids, async () => {
                if (this.fromForm.sender !== undefined) {
                    this.receive(sender, ethers_1.BigNumber.from(this.toForm.chainId), receiver, ids, sendingId);
                }
    ...
    async receive(sender, toChainId, _receiver, ids, sendingId) {
        if (this.fromForm.sender !== undefined &&
            this.toForm.sender !== undefined &&
            ...
            if (receiver === _receiver) {
                try {
                    const nftName = this.store.get("nft") ?? "GENESIS";
                    const contract = Contracts_1.default[this.toForm.chainId][nftName];
